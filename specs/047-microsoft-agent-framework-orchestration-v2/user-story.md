...
- If Microsoft Agent Framework package APIs differ from examples, adapt implementation to the official package version selected in the project while preserving the architectural constraints above.
