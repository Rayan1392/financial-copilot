...
3. Acquire an API token through `POST /api/v2/Token` using Basic authentication, cache it
   safely, apply Bearer authentication to data requests, and refresh after expiry or one `401`.
