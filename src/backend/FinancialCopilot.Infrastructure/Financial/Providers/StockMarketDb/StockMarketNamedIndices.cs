...
{
    public sealed record NamedIndex(Guid InstrumentRef, string PersianName);

    public static readonly IReadOnlyList<NamedIndex> All =
    [
        new(Guid.Parse("36423CB8-D33B-47AD-89D4-06FA49592CBA"), "شاخص کل"),
        ...
        new(Guid.Parse("D01F9D84-A1C8-46F3-A959-800DEF9E112F"), "شاخص کل (هم‌وزن)"),
    ];
